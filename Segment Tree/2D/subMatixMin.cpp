// Testing :    https://codeforces.com/gym/279715/submission/79835576

const int maxn = 500 , maxm = 500;
int t[4*maxn][4*maxm],a[maxn][maxm],n,m;
// 0 based indexing
...
int sum_x(int vx, int tlx, int trx, int lx, int rx, int ly, int ry) {
    ...
    int tmx = (tlx + trx) / 2;
    return min( sum_x(vx*2, tlx, tmx, lx, min(rx, tmx), ly, ry),\
