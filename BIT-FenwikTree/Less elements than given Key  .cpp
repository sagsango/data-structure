...
int32_t main()
{
	IOS
	BIT<int>b(100);
	b.update(2,1);//insert value 2
	b.update(2,1);//insert value 2
	b.update(3,1);//insert value 2
	b.update(4,1);//insert value 2
	
    for(int i=1;i<=10;i++)
    cout<<i<<" "<<b.sum(i)<<endl;//it will count no of elements less than of equal to i;
    
    /*
     * If elements are negative of having large values
     * We can reassign those values ex:
     * given values -100 -50 -30 0 1323 2312341324 1431234215245234
     * reaasigned   : 1    2   3 4   5      6             7
     */
